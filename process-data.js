...
const {
  fetchCachedModules, fetchCachedPopulatedSystems, fetchCachedStations
} = require('./fetches');
const processedDataPath = path.join(process.cwd(), '/processed-data');

const getNameFromModule = (module) =>
...
const processStations = () => {
  ...
  fs.writeFileSync(`${processedDataPath}/stations_with_outfitting.json`, JSON.stringify(processedStations))
  console.log('FINISHED')
} // Process Stations
